...
- **Geometria dos Pinos**: Os pinos formam triângulos equiláteros com lados de 8 pixels. A distância vertical entre fileiras é calculada como ![8 \cdot \frac{\sqrt{3}}{2} \approx 6.93](https://latex.codecogs.com/png.latex?8%20\cdot%20\frac{\sqrt{3}}{2}%20\ \approx 6,93 \) pixels (~7 pixels), mas a simulação abstrai isso para manter a lógica simples.
